...
public partial class DisassemblyViewModel : IDisassemblyCommands {
    ...
    private void StepOver() {
        ...
        uint nextInstructionAddress = (uint)(debuggerLine.CanBeSteppedOver ? debuggerLine.Address + debuggerLine.InstructionLength : debuggerLine.NextExecutionAddress.Linear);

        _logger.Debug("Setting breakpoint for step over");
